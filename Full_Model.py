...
class VideoSegmentationNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        self.transenc = Transformer_Encoder(input_dim=EMBEDDED_DIMENSION, hidden_dim=EMBEDDED_DIMENSION, num_layers=4, num_heads=4, dropout=0.1)
...
def train(epochs, lr=1e-6):
    ...
    train_data = DataloaderSequential(csv_file="data_sequential_VOS.csv", batch_size=BATCH_SIZE, imageSize=256).load_data()
